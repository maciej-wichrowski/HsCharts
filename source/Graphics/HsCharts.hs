...
import Graphics.HsCharts.Plots.AreaChart
import Graphics.HsCharts.Plots.BarChart
import Graphics.HsCharts.Plots.BoxPlot
import Graphics.HsCharts.Plots.BubbleChart
import Graphics.HsCharts.Plots.LineChart
import Graphics.HsCharts.Plots.PolarChart
import Graphics.HsCharts.Plots.ScatterPlot
